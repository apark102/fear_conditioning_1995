# Practice Model for the paper An Anatomically Constrained Neural Network Model of Fear Conditioning by Armony et al.
To use just input a number between 0-14 to indicate which neuron is being paired with the unconditioned stimulus.
# Images
